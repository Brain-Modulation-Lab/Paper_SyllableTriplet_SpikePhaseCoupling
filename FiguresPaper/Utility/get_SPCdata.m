...
for subj_i = toDo %
    ...
    if isfile(PATH_clusters)
        ...
        load(PATH_clusters,'Clusters', 'nSign_pairs','n_pairs','PairsLocation_MNI', 'PPC_mat','PPCmedianperm_mat','PPCmeanperm_mat','PPCstdperm_mat','PPCz_mat','ES_mat','PLVTimeEvts','Phase_mat');
        ...
        clear Clusters nSign_pairs n_pairs PairsLocation_MNI PPC_mat PPCz_mat ES_mat PPCmedianperm_mat PPCmeanperm_mat PPCstdperm_mat PLVTimeEvts Phase_mat
    else
