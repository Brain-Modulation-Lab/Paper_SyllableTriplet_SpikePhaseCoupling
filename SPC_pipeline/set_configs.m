...
switch mode
    case "default"
        ...
        cfg.plv.NUM_PERMS = 80;       % number of permutations, set at least to 200
    ...
    case "default-5_30Hz"
        ...
        cfg.plv.MIN_TRIALS = 10;
        cfg.plv.MAX_NAN = 40; % set max percentage of nan samples in ECoG (whole session);
        cfg.plv.freqsOfInt = [4:2.5:30; 8:2.5:34]';
        cfg.plv.gamma_env = false;
    ...
    case "default-beta"
        ...
        cfg.plv.NUM_PERMS = 0;       % number of permutations, set at least to 200
        cfg.plv.PERM_WIN_LEN_SEC = 2; % this is used to permute the phase-signal, the exact number does not matter,
        % it only needs to be longer than the largest bin that you'll use to compute the PLV with
        ...
        cfg.plv.MIN_TRIALS = 10;
        cfg.plv.MAX_NAN = 40; % set max percentage of nan samples in ECoG (whole session);
        cfg.plv.freqsOfInt = [8:35]';

        cfg.stat.DEACTIVATE_MPC = true; %  deactivate multiple comparison correction if true
        cfg.stat.FOCUS_SIGTEST = false; % default false
    ...
    case "gamma_env"
        ...
        cfg.plv.MIN_TRIALS = 10;
        cfg.plv.MAX_NAN = 40; % set max percentage of nan samples in ECoG (whole session);
        cfg.plv.freqsOfInt = [4:3:32; 8:3:36]';
        cfg.plv.gamma_env = true;
        cfg.plv.gamma_env_BPF = [60 180];
    ...
    case "power_trimming_low"
        ...
        cfg.locked = false;
        cfg.powertrim = true;
        cfg.powertrim_direction = 'low';
        cfg.powertrim_prctile = 10;

  case "power_trimming_high"
        ...
        cfg.locked = false;
        cfg.powertrim = true;
        cfg.powertrim_direction = 'high';
        cfg.powertrim_prctile = 90;       
end